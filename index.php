...
<!--------MAIN NAVIGATION-------->
  ...
  <div>
    <div style="background:#1E282C;color: white;padding: 13px 17px;border-left: 3px solid #3C8DBC;"><span><i class="fa fa-dashboard"></i> Dashboard</span></div>
    <div class="item">
      <ul class="nostyle zero">
        <a href="index.php"><li style="color: white"><i class="fa fa-circle-o"></i> Home</li></a>
        <a href="inventeries.php"><li><i class="fa fa-circle-o"></i> Inventeries</li></a>
       <a href="addnew.php"><li><i class="fa fa-circle-o"></i> Add New Item</li></a>
        <a href="reports.php"><li><i class="fa fa-circle-o"></i> Report</li></a>
      </ul>

    </div>
  </div>
  <div style="background:#1E282C;color: white;padding: 13px 17px;border-left: 3px solid #3C8DBC;"><span><i class="fa fa-globe"></i> Other Menu</span></div>
  <div class="item">
      <ul class="nostyle zero">
        <a href="sitesetting.php"><li><i class="fa fa-circle-o"></i> Site Setting</li></a>
       <a href="profile.php"><li><i class="fa fa-circle-o"></i> Profile Setting</li></a>
        <a href="accountSetting.php"><li><i class="fa fa-circle-o"></i> Account Setting</li></a>
        <a href="logout.php"><li><i class="fa fa-circle-o"></i> Sign Out</li></a>
      </ul><
    </div>
</div>
...
<div class="marginLeft" >
 <div style="color:white;background:#3C8DBC" >
    <div class="pull-right flex rightAccount" style="padding-right: 11px;padding: 7px;">
      <div><img src="photo/<?php echo $user['pic'] ?>" style='width: 43px;height: 43px;' class='img-circle'></div>
